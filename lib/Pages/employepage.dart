...
class EmployedPage extends StatefulWidget {
  const EmployedPage({Key? key}) : super(key: key);

  @override
  _EmployedPageState createState() => _EmployedPageState();
}

class _EmployedPageState extends State<EmployedPage> {
          ...
          Expanded(
            child: Container(
              ...
              child: HorizontalDataTable(
                ...
                itemCount: isSearch == true ? employeeListSearch.length : employeeList.length,
